...
public class BlueClose extends AutonBase {
    ...
    private final Pose startPose = new Pose(21,122, Math.toRadians(45));


    private final Pose scorePreloadPose = new Pose(34,110,Math.toRadians(45));


    private final Pose scorePose = new Pose (48,96,Math.toRadians(45));


    private final Pose collectTopPose = new Pose(41,85,Math.toRadians(0));


    private final Pose intakeTop = new Pose(30,85,Math.toRadians(0)); //119 -> 114


    private final Pose collectMidPose = new Pose(41,60, Math.toRadians(0));


    private final Pose intakeMiddle = new Pose(30,60,Math.toRadians(0));


    private final Pose collectBottomPose = new Pose(41,36,Math.toRadians(0));


    private final Pose intakeBottom = new Pose(30,36,Math.toRadians(0));


    private final Pose scoreBottomPose = new Pose(64,23,Math.toRadians(55));


    private final Pose parkPose = new Pose(54,120,Math.toRadians(90));


    /**CONTROL POINTS**/


    private final Pose controlPoint1 = new Pose(89,85, Math.toRadians(0)); //changed from 55,85 for straighter line
    private final Pose controlPoint2 = new Pose (74, 65, Math.toRadians(0));
    private final Pose controlPoint3 = new Pose(79,45, Math.toRadians(0));
