...
public class RedClose extends AutonBase {
    ...
    private final Pose intakeTopPose = new Pose(132,83.5,Math.toRadians(90));

    private final Pose collectMidPose = new Pose(103,60, Math.toRadians(90));

    private final Pose intakeMidPose = new Pose(132,60, Math.toRadians(90));

    private final Pose collectBottomPose = new Pose(103,36,Math.toRadians(90));

    private final Pose intakeBottomPose = new Pose(132,36,Math.toRadians(90));
...
//        follower = new Follower(hardwareMap);
        ...
        //start positions
//        Robot.getInstance().catapult1.getCurrentPosition() = SubsystemConstants; make a down value
