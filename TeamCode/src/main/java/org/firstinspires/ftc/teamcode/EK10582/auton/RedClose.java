...
public class RedClose extends AutonBase {
    ...
    private final Pose scorePreloadPose = new Pose(115,115,Math.toRadians(45));

    private final Pose scorePose = new Pose (96,96,Math.toRadians(45));

    private final Pose collectTopPose = new Pose(103,83.5,Math.toRadians(0));

    private final Pose intakeTop = new Pose(119,83.5,Math.toRadians(0));

    private final Pose collectMidPose = new Pose(103,60, Math.toRadians(0));

    private final Pose intakeMiddle = new Pose(119,60,Math.toRadians(0));

    private final Pose collectBottomPose = new Pose(103,36,Math.toRadians(0));

    private final Pose intakeBottom = new Pose(119,36,Math.toRadians(0));

    private final Pose scoreBottomPose = new Pose(104,59,Math.toRadians(60));
    ...
    private final Pose controlPoint2 = new Pose (55, 65, Math.toRadians(0));
    private final Pose controlPoint3 = new Pose(55,45, Math.toRadians(0));
